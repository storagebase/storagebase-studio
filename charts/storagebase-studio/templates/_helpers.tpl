...
*/}}
{{- define "storagebase-studio.name" -}}
...
*/}}
{{- define "storagebase-studio.fullname" -}}
...
*/}}
{{- define "storagebase-studio.chart" -}}
...
Common labels
*/}}
{{- define "storagebase-studio.labels" -}}
helm.sh/chart: {{ include "storagebase-studio.chart" . }}
{{ include "storagebase-studio.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "storagebase-studio.selectorLabels" -}}
app.kubernetes.io/name: {{ include "storagebase-studio.name" . }}
...
*/}}
{{- define "storagebase-studio.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "storagebase-studio.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "storagebase-studio.secretName" -}}
{{- if .Values.secrets.existingSecret }}
{{- .Values.secrets.existingSecret }}
{{- else }}
{{- include "storagebase-studio.fullname" . }}
{{- end }}
{{- end }}
...
*/}}
{{- define "storagebase-studio.configMapName" -}}
{{- printf "%s-config" (include "storagebase-studio.fullname" .) }}
{{- end }}

{{/*
Return the PVC name (existing or generated)
*/}}
{{- define "storagebase-studio.pvcName" -}}
{{- if .Values.persistence.existingClaim }}
{{- .Values.persistence.existingClaim }}
{{- else }}
{{- printf "%s-data" (include "storagebase-studio.fullname" .) }}
{{- end }}
{{- end }}
...
*/}}
{{- define "storagebase-studio.persistenceEnabled" -}}
...
*/}}
{{- define "storagebase-studio.authStrict" -}}
...
*/}}
{{- define "storagebase-studio.localAuth" -}}
...
*/}}
{{- define "storagebase-studio.storageProvider" -}}
...
*/}}
{{- define "storagebase-studio.autoscalingEnabled" -}}
{{- if and .Values.autoscaling.enabled (ne (include "storagebase-studio.storageProvider" .) "sqlite") }}
{{- true }}
{{- end }}
{{- end }}
...
*/}}
{{- define "storagebase-studio.agentFlagSet" -}}
...
*/}}
{{- define "storagebase-studio.agentTuningSet" -}}
...
*/}}
{{- define "storagebase-studio.agentTuningKey" -}}
{{- $tuning := get (.Values.agent | default dict) "modelTuning" | default dict }}
...
*/}}
{{- define "storagebase-studio.agentPossible" -}}
{{- $agent := .Values.agent | default dict }}
{{- $keyless := list "ollama" "custom" }}
{{- if include "storagebase-studio.agentFlagSet" . }}
...
*/}}
{{- define "storagebase-studio.multiReplica" -}}
{{- if include "storagebase-studio.autoscalingEnabled" . }}
...
*/}}
{{- define "storagebase-studio.agentPostgresWorld" -}}
...
*/}}
{{- define "storagebase-studio.adaptOpenShiftSecurityContext" -}}
...
*/}}
{{- define "storagebase-studio.podSecurityContext" -}}
{{- $psc := .Values.podSecurityContext }}
{{- if include "storagebase-studio.adaptOpenShiftSecurityContext" . }}
...
*/}}
{{- define "storagebase-studio.effectiveBindAddress" -}}
...
allows it.
*/}}
{{- define "storagebase-studio.bindPinnedToIPv4" -}}
{{- $bind := include "storagebase-studio.effectiveBindAddress" . }}
...
pairing.
*/}}
{{- define "storagebase-studio.serviceWantsIPv6" -}}
...
*/}}
{{- define "storagebase-studio.postgresql.fullname" -}}
...
*/}}
{{- define "storagebase-studio.postgresql.url" -}}
{{- printf "postgresql://%s:$(POSTGRES_PASSWORD)@%s:5432/%s" .Values.postgresql.auth.username (include "storagebase-studio.postgresql.fullname" .) .Values.postgresql.auth.database }}
{{- end }}

{{/* Prefix only the shipped health path; preserve explicit HTTP/exec/TCP probes. */}}
{{- define "storagebase-studio.probe" -}}
